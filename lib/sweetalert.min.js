    ...
    function a(s, l) {
      if (!t[s]) {
        if (!e[s]) {
          ...
          if (!l && i) return i(s, !0);
          if (r) return r(s, !0);
          var u = new Error("No se puede encontrar el módulo '" + s + "'");
          throw ((u.code = "MÓDULO_NO_ENCONTRADO"), u);
        }
        var c = (t[s] = { exports: {} });
        e[s][0].call(
          c.exports,
        ...
        function(o, a, r) {
          ...
          (r["default"] = u = c = function() {
            ...
            if ((d.addClass(t.body, "stop-scrolling"), p.resetInput(), a === n))
              return f.logStr("SweetAlert espera al menos 1 atributo!"), !1;
            ...
            switch (typeof a) {
              ...
              case "object":
                if (a.title === n)
                  return f.logStr('Falta el "título" del argumento!'), !1;
                r.title = a.title;
            ...
            (u.setDefaults = c.setDefaults = function(e) {
              if (!e) throw new Error("se requieren los userParams");
              if ("object" != typeof e)
                throw new Error("userParams tiene que ser un objeto");
            ...
            "undefined" != typeof e
              ...
              : f.logStr("SweetAlert es un módulo frontend!"),
            (a.exports = r["default"]);
        },
        {
              ...
              if (e.imageUrl) {
                ...
                if (e.imageSize) {
                  ...
                  h && b
                    ? ((m = h), (v = b))
                    : logStr(
                        "Parameter imageSize espera el valor con el formato WIDTHxHEIGHT, got " +
                          e.imageSize
                      );
                }
                p.setAttribute(
